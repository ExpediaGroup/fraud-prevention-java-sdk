...
import com.expediagroup.sdk.fraudpreventionv2.models.RailSegmentsOperatingCompany
import com.expediagroup.sdk.fraudpreventionv2.models.RailwayStationDetails
...
data class RailSegments(
    ...
    class Builder(
        ...
        private fun validate(instance: RailSegments) {
            val validator =
                Validation
                    .byDefaultProvider()
                    .configure()
