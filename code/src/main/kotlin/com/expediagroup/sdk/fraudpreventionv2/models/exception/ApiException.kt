    ...
    private val httpStatusCodeRanges: Map<String, List<HttpStatusCodeRange>> =
        mapOf(
            Pair(
                ...
                listOf(
                    ...
                    HttpStatusCodeRange("403") {
                        ExpediaGroupApiForbiddenErrorException(it.status.value, fetchErrorObject(it) as ForbiddenError, it.headers.getTransactionId())
                    },
                    ...
                    HttpStatusCodeRange("502") {
                        ExpediaGroupApiBadGatewayErrorException(it.status.value, fetchErrorObject(it) as BadGatewayError, it.headers.getTransactionId())
                    },
            ...
            Pair(
                ...
                listOf(
                    HttpStatusCodeRange("400") {
                        ExpediaGroupApiBadRequestErrorException(it.status.value, fetchErrorObject(it) as BadRequestError, it.headers.getTransactionId())
                    },
                    HttpStatusCodeRange("401") {
